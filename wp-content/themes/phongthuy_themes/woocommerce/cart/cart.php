...
<div class="top-content">
    <p class="orderReview-title">Giỏ hàng</p>
    <p class="orderReview-text">Xem lại đơn hàng của bạn với <strong><?php echo WC()->cart->get_cart_contents_count() ?>
            sản phẩm </strong>
        và tổng tiền <?php wc_cart_totals_order_total_html(); ?>
    </p>
</div>
...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
    ...
    <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
        <thead>
            <tr>
                <th class="product-remove abc"><span
